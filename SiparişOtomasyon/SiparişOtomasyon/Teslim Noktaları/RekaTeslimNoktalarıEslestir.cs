...
namespace SiparişOtomasyon.Teslim_Noktaları
{
    public partial class RekaTeslimNoktalarıEslestir : Form
    {
        ...
        private void RekaTeslimNoktalarıEslestir_Load(object sender, EventArgs e)
        {
        ...
        private void LoadTblEslesmelerleData()
        {
            ...
            gridControlRekaEslesme.DataSource = data; // gridControlReka adında bir grid control olduğunu varsayıyoruz
        }
        ...
        {
            var gridControl1Data = gridControlRekaEslesme.DataSource as List<TblEslesmelerle>;
            ...
            gridControlRekaEslesme.DataSource = sortedRecords;
            ...
            gridViewRekaEslesme.RefreshData();
        }
